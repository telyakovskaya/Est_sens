...
def measure_stimuli():
    ...
    #         img_path = join(r"C:\Users\Пользователь\Desktop\python\iipt\Calculation of sensitivities\dng_D50", "img_" + str(8332 + exp) + ".dng")
    #         json_path = join(r"C:\Users\Пользователь\Desktop\python\iipt\Calculation of sensitivities\D50_targed", "img_" + str(8332 + exp) + ".jpg.json")
    #         img = process(img_path).astype(np.float32)
